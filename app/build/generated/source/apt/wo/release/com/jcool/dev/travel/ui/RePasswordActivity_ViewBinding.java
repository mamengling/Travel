...
public class RePasswordActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public RePasswordActivity_ViewBinding(RePasswordActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public RePasswordActivity_ViewBinding(RePasswordActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RePasswordActivity target = this.target;
