...
public class EdtUserInfoActivity_ViewBinding implements Unbinder {
  private EdtUserInfoActivity target;

  @UiThread
  public EdtUserInfoActivity_ViewBinding(EdtUserInfoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public EdtUserInfoActivity_ViewBinding(EdtUserInfoActivity target, View source) {
    this.target = target;
    ...
    target.edt_key = Utils.findRequiredViewAsType(source, R.id.edt_key, "field 'edt_key'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    EdtUserInfoActivity target = this.target;
