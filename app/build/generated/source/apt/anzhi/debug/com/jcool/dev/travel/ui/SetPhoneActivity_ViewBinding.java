...
public class SetPhoneActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public SetPhoneActivity_ViewBinding(SetPhoneActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SetPhoneActivity_ViewBinding(SetPhoneActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SetPhoneActivity target = this.target;
