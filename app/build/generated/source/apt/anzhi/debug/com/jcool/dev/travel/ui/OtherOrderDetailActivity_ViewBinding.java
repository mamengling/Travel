...
public class OtherOrderDetailActivity_ViewBinding implements Unbinder {
  private OtherOrderDetailActivity target;

  @UiThread
  public OtherOrderDetailActivity_ViewBinding(OtherOrderDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public OtherOrderDetailActivity_ViewBinding(OtherOrderDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OtherOrderDetailActivity target = this.target;
