...
public class PayActivity_ViewBinding implements Unbinder {
  ...
  public PayActivity_ViewBinding(PayActivity target, View source) {
    ...
    target.image_yinlian = Utils.findRequiredViewAsType(source, R.id.image_yinlian, "field 'image_yinlian'", ImageView.class);
    ...
    target.line_yinlian = Utils.findRequiredViewAsType(source, R.id.line_yinlian, "field 'line_yinlian'", LinearLayout.class);
  }
  ...
  public void unbind() {
    ...
    target.image_yinlian = null;
    target.line_weixin = null;
    target.line_alipay = null;
    target.line_yinlian = null;
  }
}
