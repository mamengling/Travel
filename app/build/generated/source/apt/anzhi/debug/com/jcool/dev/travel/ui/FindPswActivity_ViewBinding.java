...
public class FindPswActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public FindPswActivity_ViewBinding(FindPswActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FindPswActivity_ViewBinding(FindPswActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FindPswActivity target = this.target;
