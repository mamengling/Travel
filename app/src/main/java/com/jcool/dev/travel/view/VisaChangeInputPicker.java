...
public class VisaChangeInputPicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    public VisaChangeInputPicker(Context mContext, Callback callback, List<String> mStrUnits) {
...
//        mCallback.onSelected(textChange);
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.dialog_visa_picker);
