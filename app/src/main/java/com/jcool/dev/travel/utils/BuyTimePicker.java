...
import com.jcool.dev.travel.view.PickerView;
...
public class BuyTimePicker implements View.OnClickListener, PickerView.OnSelectListener  {
    ...
    private TextView mtv_year, mtv_month, mtv_day, mTvHourUnit, mTvMinuteUnit;
     ...
     */
    public BuyTimePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public BuyTimePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mtv_year = mPickerDialog.findViewById(R.id.mtv_year);
        mtv_month = mPickerDialog.findViewById(R.id.mtv_month);
        mtv_day = mPickerDialog.findViewById(R.id.mtv_day);
    ...
    public void show(String dateStr) {
        ...
        // 弹窗时，考虑用户体验，不展示滚动动画
        if (setSelectedTime(dateStr, true)) {
            mPickerDialog.show();
        }
    }
    ...
    public void setCanShowPreciseTime(boolean canShowPreciseTime) {
        ...
        if (canShowPreciseTime) {
            ...
            mtv_year.setVisibility(View.VISIBLE);
            mDpvMonth.setVisibility(View.VISIBLE);
            mtv_month.setVisibility(View.VISIBLE);
            mDpvDay.setVisibility(View.VISIBLE);
            mtv_day.setVisibility(View.VISIBLE);
