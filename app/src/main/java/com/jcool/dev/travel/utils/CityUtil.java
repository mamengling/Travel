...
public  class CityUtil {
    public static String[] getmCitiesStrings() {
        return mCitiesStrings;
    }

    public static final String[] mCitiesStrings = {
            "阿拉善盟", "鞍山", "安庆", "安阳", "阿坝", "安顺", "阿里", "安康", "阿克苏", "阿勒泰" ,"澳门" ,"安吉" ,"安丘" ,"安岳" ,"安平" ,"安溪" ,"安宁" ,"安化" ,"阿拉尔" ,"安福" ,"阿勒泰市",
            "阿图什市" ,"安州市" ,"阿荣旗" ,"安陆市" ,
            "北京", "保定", "蚌埠", "包头", "巴彦淖尔", "本溪", "白山", "白城", "亳州", "滨州", "北海", "百色", "巴中", "毕节","保山" ,"宝鸡" ,"白银" ,"博尔塔拉" ,"巴州" ,"滨海" ,"宝应" ,"北流" ,"博爱" ,"北i碚" ,"宝丰" ,
            "博兴" ,"泌阳" ,"彬县" ,"璧山" ,"博山" ,"宾阳" ,"泊头市" ,"博罗县" ,"博白县" ,"北镇市" ,"北安市" ,"巴彦县","巴楚县","拜城县",
            "重庆", "成都", "长沙","常州","长春","承德","沧州","长治","赤峰","朝阳","滁州","巢湖"," 池州","常德","郴州",
            ...
            "大连", "大庆", "东莞", "大同", "丹东","大兴安岭","东营","德州","德阳","达州","大理","德宏","迪庆","定西","丹阳","敦煌","东阳","德清","大丰","东台",
            ...
            "鄂尔多斯", "恩施", "鄂州","峨眉山","额尔古纳","恩平","额敏县",
            "福州", "佛山", "抚顺", "阜新", "阜阳", "抚州", "防城港","富阳","涪陵","福清","凤凰","阜宁","奉化","肥城","凤城","汾阳","阜康","丰城","范县","繁昌","肥乡","封丘","扶风","丰县","抚松","富顺",
            "费县","佛冈","丰宁","扶沟","凤台","奉新","方城","富源县","分宜","扶绥县","肥西县", "繁峙县","凤翔县","福安","福鼎市","府谷县","富民",
            "广州", "桂林", "贵阳", "赣州","贵港","广元","广安","甘孜","甘南","果洛","固原","高邮","广饶","巩义","桂平","公主岭","高密","广汉","藁城", "高平","高碑店","个旧","高州","盖州","古交","格尔木",
            "高雄","灌云","灌南","赣榆","高安","广德","共青城","高阳","高陵","公安","鼓浪屿","固始县","光泽","光山县",
            "杭州","合肥","海口","葫芦岛","哈尔滨","邯郸","衡水","呼和浩特","呼伦贝尔","鹤岗","黑河","淮安","湖州","淮南","淮北", "黄山","菏泽","鹤壁","黄石","黄冈","衡阳","怀化","惠州","河源","贺州","河池",
            ...
            "济南","焦作","锦州","九江","晋城","晋中","吉林","鸡西","佳木斯","嘉兴","金华","景德镇","吉安","济宁","济源", "荆门","荆州","江门","揭阳","金昌","酒泉","江阴","嘉峪关","晋江","靖江","金坛","九寨沟","井冈山",
            "嘉善","江山","句容","建湖","晋州","胶州","建德","简阳","介休","即墨","嘉义市","集安","基隆","蛟河","建阳","金堂","","","","",
            "昆明", "开封", "昆山",
            "廊坊", "丽水","柳州","洛阳","莱芜","莱西","莱州","兰州","丽江","溧水县","连云港","聊城","临安","临海","临沂","陵水县","六安","六盘水","龙海","龙口","龙门县","龙岩","泸州","漯河","浏阳","乐山",
            "马鞍山", "茂名", "眉山", "梅州","绵阳","闽侯","牡丹江",
             "南安","南京", "南昌", "南宁", "宁波", "南充", "南平", "南通", "南阳", "那曲", "内江", "宁德", "怒江","宁海县", "宁河县",
             "盘锦", "攀枝花", "平顶山", "平凉", "萍乡", "莆田", "濮阳","沛县","邳州","平湖","普洱","普宁","普兰店","蒲江","彭州",
            "青岛", "黔东南", "黔南", "黔西南", "庆阳", "清远", "秦皇岛", "钦州", "齐齐哈尔", "泉州", "曲靖", "衢州", "綦江县","启东","潜江",
             "日喀则","日照","荣昌县","如东县","瑞安",
             "上海", "深圳", "苏州","厦门", "沈阳", "石家庄", "三门峡", "三明", "三亚", "商洛", "商丘", "上饶", "山南", "汕头", "汕尾", "韶关", "绍兴", "邵阳", "十堰", "朔州", "四平", "绥化", "遂宁", "随州", "宿迁", "宿州",
            "上虞","嵊州","四方","松原","随州","双流",
             "天津", "太原", "泰安", "泰州", "台州", "唐山", "天水", "铁岭", "铜川", "通化", "通辽", "铜陵", "铜仁", "台湾","太仓","泰兴","桐庐县","铜梁县","潼南县","天门",
            "武汉", "乌鲁木齐", "无锡", "威海", "潍坊", "文山", "温州", "乌海", "芜湖", "乌兰察布", "武威", "梧州","瓦房店","吴江",
             "厦门", "西安", "西宁", "襄樊", "湘潭", "湘西", "咸宁", "咸阳", "孝感", "邢台", "新乡", "信阳", "新余", "忻州", "西双版纳", "宣城", "许昌", "徐州", "香港", "锡林郭勒", "兴安","仙桃","咸阳","香河","襄阳","象山县",
            "新沂","兴化","宿迁","宿州","宣城","新津",
            "银川", "雅安", "延安", "延边", "盐城", "阳江", "阳泉", "扬州", "烟台", "宜宾", "宜昌", "宜春",
            "营口", "益阳", "永州", "岳阳", "榆林", "运城", "云浮", "玉树", "玉溪", "玉林","宜昌","伊春","宜兴","鹰潭","余姚","义乌",
             "杂多县", "赞皇县", "枣强县", "枣阳市", "枣庄", "泽库县", "增城市", "曾都区", "泽普县", "泽州县", "札达县", "扎赉特旗",
