...
public class YRecycleviewRefreshHeadView extends LinearLayout {
    ...
    ImageView _refresh_waiting_image;
    ...
    private void initView(Context context) {
        ...
        update_time = (TextView) mContentView.findViewById(R.id.update_time);
        _refresh_waiting_image = (ImageView) mContentView.findViewById(R.id._refresh_waiting_image);
        update_time.setText("最后更新：今天" + AppUtils.getTime());
        //宽高
