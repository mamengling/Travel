...
public class UserInfoGetPresenter {
    ...
    public void getUserInfoToken(String token) {
        mUserInfoGetView.showProgress();
        HttpUtil.get(Constants.BASE_URL + Constants.APP_HOME_API_USER_INFO_2, token, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                mUserInfoGetView.showProgress();
    ...
    public void getUserUpdate(String token) {
        mUserInfoGetView.showProgress();
        HttpUtil.put(mContext, Constants.BASE_URL + Constants.APP_HOME_API_USER_INFO_UPDATE, token, mUserInfoGetView.getParamenters(), new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                mUserInfoGetView.showProgress();
